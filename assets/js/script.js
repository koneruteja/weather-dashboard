$(document).ready(function(){
    ...
    function displayWeatherInfo(city) {
        ...
        var queryURL = "https://api.openweathermap.org/data/2.5/weather?q=" + city + "&APPID=6e8ca1f98f05367f114dd72da0586ded";
      ...
      function findUVIndex() {
        ...
        var indexURL = "https://api.openweathermap.org/data/2.5/uvi?APPID=6e8ca1f98f05367f114dd72da0586ded&lat=" + latPush[1] + "&lon=" + lonPush[1];
      ...
      function displayForecast(city) {
        ...
        var forecastURL = "https://api.openweathermap.org/data/2.5/forecast?q=" + city + "&APPID=6e8ca1f98f05367f114dd72da0586ded";
